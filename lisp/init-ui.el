...
(use-package dashboard
  ...
  (setq dashboard-navigator-buttons `(((,(if (fboundp 'nerd-icons-octicon) (nerd-icons-octicon "nf-oct-mark_github") "★")
                                        "My GitHub" "Browse" (lambda (&rest _) (browse-url homepage-url)))
                                       (,(if (fboundp 'nerd-icons-octicon) (nerd-icons-octicon "nf-oct-heart") "♥")
                                        "WorkSpace" "zkLink Github" (lambda (&rest _) (browse-url zklink-url)))
                                       (,(if (fboundp 'nerd-icons-octicon) (nerd-icons-octicon "nf-oct-heart") "♥")
                                        "Docs" "zkLink Docs" (lambda (&rest _) (browse-url docs-url)))
  ...
  :config
  (defconst homepage-url "https://github.com/zkcarter?tab=repositories")
  (defconst zklink-url "https://github.com/zkLinkProtocol")
  (defconst docs-url "https://github.com/zkLinkProtocol/zklink-tech-docs")
  :custom
